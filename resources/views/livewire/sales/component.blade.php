                                ...
                                <div class="overflow-x-auto">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="bg-gray-200 dark:bg-dark-1 text-lg">
                                                ...
                                                <td>
                                                    <div class="inline-flex" role="group" style="font-size: 1.6em!important;">
                                                        ...
                                                        <button  wire:click.prevent="decreaseQty({{$item->id}})" class="btn btn-primary ml-4"><i class="fas fa-minus "></i></button>
                                                        <button  wire:click.prevent="increaseQty({{$item->id}})" class="btn btn-primary ml-4 {{ $item->livestock > 0 ? '' :'hidden' }} " ><i class="fas fa-plus"></i>
                                                        </button>
                                                    </div>
                                                </td>
                                            </tr>
                                            @empty
                                            <tr>
                                                <td colspan="5" class="text-center">Agregar productos al carrito</td>
                                            </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
            ...
            <div class="intro-y box p-5">
                ...
                <div class="mt-8">
                    ...
                    @if($totalCart >0 && ($cash >= $totalCart))
                        ...
                        <button wire:loading.attr="disabled" wire:target="storeSale" wire:click.prevent="storeSale" class="btn btn-primary w-full mt-5"><i class="fas fa-database mr-2"></i> Guardar Venta</button>
