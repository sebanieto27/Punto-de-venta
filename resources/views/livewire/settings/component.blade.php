       ...
       <div id="vertical-form" class="p-5">
        <div class="preview grid grid-cols-12 gap-5">
            ...
            <div class="col-span-12">
                ...
                class="form-control  kioskboard"  placeholder="eje: Traigo y llevo" />
                @error('name')
                <x-alert msg="{{ $message }}" />
                @enderror
            </div>
            ...
            <div class="col-span-12">
                <label  class="form-label">Imágen (Logo principal)</label>
                <input wire:model="logoPrincipal" accept="image/x-png,image/jpeg,image/jpg" class="form-control" type="file">
                @error('logoPrincipal')
                    <x-alert msg="{{ $message }}" />
                @enderror
            </div>
            ...
            <div class="col-span-12 md:col-span-3 ">
                @if($logoPrincipalPreview)
                    <img class="rounded-lg recent-product-img " data-action="zoom" src="{{ asset($logoPrincipalPreview) }}" width="150px">
                    <h5>Logo actual</h5>
                @endif
            ...
            <div class="col-span-12 md:col-span-3 flex justify-center" >
                @if($logoPrincipal)
                <div>
                    <img class="rounded-lg  recent-product-img" src="{{ $logoPrincipal->temporaryUrl() }}" width="150px">
